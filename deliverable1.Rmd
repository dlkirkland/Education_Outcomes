...
#Create an array to store the CY datasets
datasets <- c("")
...
```
The number of variables/columns in each dataset total 1,978, therefore, there are too many to list here.  But a dictionary is include which  
